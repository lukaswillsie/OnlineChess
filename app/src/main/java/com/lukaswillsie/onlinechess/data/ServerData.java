...
public enum ServerData {
    ...
    WHITE_CHK('i', 11, 0),          // 1 if white is in check, 0 if not
    BLACK_CHK('i', 12, 0),          // 1 if black is in check, 0 if not
    PROMOTION_NEEDED('i', 13, 0);   // 1 if the player whose turn it is needs to promote a piece before their turn can end
